...
class Param:
    def __init__(self, ncpu, ngroup, workload):
        ...
        DRAMSIM = os.getenv('DRAMSIM3_HOME')
        if DRAMSIM is None:
            print('params2.py: ERROR: Unabled to find environment variable `DRAMSIM3_HOME`')
            sys.exit(1)

        self.dramsim3 = {
            "config_ini"  : f"{DRAMSIM}/configs/HBM2_8Gb_x128.ini",
            "mem_size"    : "8GiB",
        }
