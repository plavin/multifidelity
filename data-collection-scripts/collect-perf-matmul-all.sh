...
for sz in 2KiB 4KiB 8KiB;
do
for i in {1..3}
do
    echo "--------" Run Norm $i size=$sz "--------"
    ./simulate.py -s two-level.py -c matmul-128-workloads.py -p l1 -B --stop-at=25ms -z $sz
done
for i in {1..3}
do
...
do
    ...
    ./simulate.py -s two-level.py -c matmul-128-workloads.py -p l1 -B --stop-at=25ms -N $threads
done
for i in {1..3}
do
